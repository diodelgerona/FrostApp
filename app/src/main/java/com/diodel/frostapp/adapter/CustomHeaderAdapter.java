 ...
 * @author ISchwarz
 */
public final class CustomHeaderAdapter extends TableHeaderAdapter {
     ...
     */
    public CustomHeaderAdapter(final Context context, final String... headers) {
        super(context);
        this.headers = headers;
    }

    public CustomHeaderAdapter(final Context context, final int... headerStringResources) {
        super(context);
